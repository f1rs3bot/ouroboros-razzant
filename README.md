...
[![Version 7.0.7](https://img.shields.io/badge/version-7.0.7-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/Ouroboros-7.0.7.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/Ouroboros-7.0.7-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/ouroboros_7.0.7_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/ouroboros-7.0.7-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/ouroboros-7.0.7-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/Ouroboros-7.0.7-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.7/Ouroboros-7.0.7-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.7 | 2026-09-13 | **fix: leaked model control output is quarantined before it can become owner-facing speech.** A real generation beginning with `<\|close\|>` previously passed through candidate acceptance, durable results, live chat, and replay as a huge corrupted answer. The ordinary and forced terminal paths now share a narrow evidence-backed integrity boundary: only the observed marker at the start of model-authored output is rejected; the exact raw UTF-8 bytes are preserved privately under their SHA-256 identity, while the public result becomes a short host-authored failure notice and no acceptance panel is spent. Technical prose and code that quote the marker internally remain byte-exact. |
