...
[![Version 7.0.6](https://img.shields.io/badge/version-7.0.6-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/Ouroboros-7.0.6.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/Ouroboros-7.0.6-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/ouroboros_7.0.6_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/ouroboros-7.0.6-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/ouroboros-7.0.6-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/Ouroboros-7.0.6-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v7.0.6/Ouroboros-7.0.6-linux-x86_64.tar.gz
...
|---------|------|-------------|
| 7.0.6 | 2026-09-13 | **feat: a typed provider rejection teaches the route its serialized prompt-size bound — the codex-lb class dies once, not every round.** v7.0.5 classified codex-lb's `string_above_max_length` (on `instructions`, the serialized system content) as a context overflow and added a low reprojection; the classification worked, but every task still paid a doomed ~300K-token first call on round 1 before the recovery fired. The typed rejection body (e.g. codex-lb's `param=instructions` + `maximum length 1048576`) now persists a route-fingerprint-scoped serialized bound in `capability_evidence.json` (14-day TTL, fail-open), and `loop_model_call._prompt_size_gate` consults it **before** the measuring step can spend a reclaim summarizer: an over-bound candidate reprojects to task-local Low without a paid send, and a still-over-bound candidate emits the typed `prompt_size_bound_exceeded` skip. Routes without a proven violation are unbounded by design. |
